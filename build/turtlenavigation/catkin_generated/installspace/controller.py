...
class Controller:
    ...
    def __init__(self):
        ...
        self.sub2 = rospy.Subscriber("path_array", Float64MultiArray,
                                     self.callback2)
        ...
        self.kp_ang = 0.01
        self.ki_ang = 0.002
        self.kd_ang = 0.0001  #p down d increase

        while not rospy.is_shutdown():
            vel_msg = Twist()
            if self.path_array:
                print(self.rot_flag)
                print(self.goal[1], self.y, self.goal[0], self.x)
                print(
                ...
                if math.hypot(self.x - self.goal[0],
